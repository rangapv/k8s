...
kubegist() {
   ...
   then	   
	...
	wg=`sudo wget https://gist.githubusercontent.com/rangapv/3fd8a52f66bd412b1cc0663a45c74f68/raw/6bd8bc2c97b76e7ebf2dc3b9160658e791e04aff/kube-adm-containerd.yaml `
