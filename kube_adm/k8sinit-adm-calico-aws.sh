...
kubegist() {
   ...
   then	   
	...
	wg=`sudo wget https://gist.githubusercontent.com/rangapv/ecb8d1c3cd2f22536c6f2df61dcbd92e/raw/39c0b30390ffa00340574c7abab37a6ea3787d12/adm-calico-aws-conf.yaml`
	sudo cp ./adm-calico-aws-conf.yaml ./kube-adm-old.yaml
